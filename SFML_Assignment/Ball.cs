...
namespace SFML_Assignment
{
    ...
    public class Ball : CircleShape
    {
        ...
        //Ball Constructor
        public Ball(Color fillColour, Color lineColour, int data, float radius = 20, int pointCount = 30, int lineWidth = 1) : base(radius, (uint)pointCount)
        {
            this.ballLink = null;
        ...
        //Method to get data from the ball
        public int getData()
        {
            return data;
        }

        //Method to get radius of the ball
        public float getRadius()
        {
            return Radius;
        }

        //Method to highlight the ball
        public void highLight()
        {
            this.setOutlineColor(Color.Yellow);
            this.OutlineThickness = 5f;
        }

        //Method to remove highlight of the ball
        ...
        //Method to set the link color and link width
        ...
        //Method to set position of the ball
        ...
        //Method to move the ball by inputted value
        ...
        //Method to add the rotation by given angle
        public void offsetRotation(float angle)
        {
            this.Rotation += angle;
        }

        //Method to set velocity of the ball
        ...
        //Method to set link wodth
        public void setLinkWidth(float width)
        {
            this.linkWidth = width > 0 ? width : 1;
        }

        //Method to set color of the ball
        public void setColor(Color ballColor)
        {
            this.FillColor = ballColor;
        }

        //Method to get color of the ball
        public Color getColor()
        {
            return this.FillColor;
        }

        //Method to set outline color of the ball
        public void setOutlineColor(Color color)
        {
            this.OutlineColor = color;
        }

        //Method to get outline color of the ball
        ...
        //Method to set a link to given position
        ...
        //Method to check edge collision
